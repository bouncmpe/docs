...
- In the first semester, a Thesis Progress Committee (TPC) is formed with three full-time professors[^1]. One of these members should be from another department or university.
...
- Before the defense, the thesis book has to be submitted to the Thesis Defense Jury (TDJ), which is formed of five full-time professors[^1]:
  ...
  - TDJ has to contain at least two full-time professors[^1] from another university
